        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" id="registration-form" enctype="multipart/form-data" method="PUT" action="{{ route('user.update') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="integer" class="form-control" name="phone" value="{{ auth()->user()->phone }}" required autofocus>
